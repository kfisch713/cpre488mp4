...
//    set_up_bt_chip();
    ...
    while (!SW(KILL_SWITCH)) {
    	...
    	roll = 		map(roll, 		74000, 156000, 1000, 2000);
    	pitch = 	map(pitch, 		74000, 145000, 1000, 2000);
    	throttle = 	map(throttle, 	69000, 145000, 1000, 2000);
    	yaw = 		map(yaw, 		75500, 165000, 1000, 2000);
